...
public enum Renderer3D implements Globals {
    ...
    public static void drawRiseBox(AxisAlignedBB pos, float progress, Color color) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
        ...
        float myOff = (float) (pos.minY + (pos.maxY - pos.minY) * progress);


        AxisAlignedBB axisAlignedBB = new AxisAlignedBB(pos.minX, pos.minY, pos.minZ, pos.maxX, myOff, pos.maxZ);
    ...
    public static void rhm(Object[] objectArray) {
        ...
        d -= mc.getRenderManager().renderPosX;
        d2 -= mc.getRenderManager().renderPosY;
        d3 -=mc.getRenderManager().renderPosZ;
        d4 -=mc.getRenderManager().renderPosX;
        d5 -= mc.getRenderManager().renderPosY;
        d6 -= mc.getRenderManager().renderPosZ;
