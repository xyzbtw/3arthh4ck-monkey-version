...
public class InventoryUtil implements Globals {
    ...
    public static boolean isHolding(Item item, EnumHand hand) {
        ...
        return (hand == EnumHand.OFF_HAND)
                ? ItemUtil.areSame(offHand, item)
                : ItemUtil.areSame(mainHand, item);
    }
     ...
     * </p>
     * <p>
     * -have the same item as the second stack.
     * </p>
     * <p>
     * -have a maxStackSize > 1.
     * </p>
     * <p>
     * -No Subtypes, or the same MetaData as the second stack.
     * </p>
     * <p>
