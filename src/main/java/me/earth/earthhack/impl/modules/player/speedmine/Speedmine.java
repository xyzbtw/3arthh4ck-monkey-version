...
public class Speedmine extends Module {
    ...
    public static ArrayList<BlockPos> compatibility = new ArrayList<>();
    protected final Setting<MineMode> mode = register(new EnumSetting<>("Mode", MineMode.Smart));
    protected final Setting<Boolean> noReset = register(new BooleanSetting("No-Reset", true));
    public final Setting<Float> limit = register(new NumberSetting<>("Damage", 1.0f, 0.0f, 2.0f))
            .setComplexity(Complexity.Medium);
    protected final Setting<Float> range = register(new NumberSetting<>("Range", 7.0f, 0.1f, 100.0f));
    protected final Setting<Boolean> multiTask = register(new BooleanSetting("MultiTask", false));
    protected final Setting<Boolean> rotate = register(new BooleanSetting("Rotate", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> event = register(new BooleanSetting("Event", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> display = register(new BooleanSetting("DisplayDamage", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Integer> delay = register(new NumberSetting<>("ClickDelay", 100, 0, 500))
            .setComplexity(Complexity.Medium);
    protected final Setting<ESPMode> esp = register(new EnumSetting<>("ESP", ESPMode.Outline))
            .setComplexity(Complexity.Medium);
    protected final Setting<Integer> realDelay = register(new NumberSetting<>("Delay", 50, 0, 500))
            .setComplexity(Complexity.Medium);
    ...
    protected final Setting<Boolean> swap = register(new BooleanSetting("SilentSwitch", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> strict = register(new BooleanSetting("Strict", false));
    protected final Setting<CooldownBypass> cooldownBypass = register(
            new EnumSetting<>("CoolDownBypass", CooldownBypass.None))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> requireBreakSlot =

            register(new BooleanSetting("RequireBreakSlot", false))
                    .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> placeCrystal = register(new BooleanSetting("PlaceCrystal", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> breakCrystal = register(new BooleanSetting("BreakCrystal", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> breakInstant = register(new BooleanSetting("BreakSpawningCrystals", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> offhandPlace = register(new BooleanSetting("OffhandPlace", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> offhandSilent = register(new BooleanSetting("OffhandSilent", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> megaSilent = register(new BooleanSetting("MegaSilent", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> antiAntiSilentSwitch = register(new BooleanSetting("AntiAntiSilentSwitch", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> prePlace = register(new BooleanSetting("PrePlace", false))
            .setComplexity(Complexity.Medium);
    public final Setting<Float> prePlaceLimit = register(new NumberSetting<>("PrePlaceLimit", 0.95f, 0.0f, 2.0f))
            .setComplexity(Complexity.Medium);
    protected final Setting<Bind> breakBind = register(new BindSetting("BreakBind", Bind.none()))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> normal = register(new BooleanSetting("Normal", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> resetAfterPacket = register(new BooleanSetting("ResetAfterPacket", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> checkPacket = register(new BooleanSetting("CheckPacket", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> swingStop = register(new BooleanSetting("Swing-Stop", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> limitRotations = register(new BooleanSetting("Limit-Rotations", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Integer> confirm = register(new NumberSetting<>("Confirm", 500, 0, 1000))
            .setComplexity(Complexity.Medium);
    protected final Setting<Double> crystalRange = register(new NumberSetting<>("CrystalRange", 6.0, 0.0, 10.0))
            .setComplexity(Complexity.Medium);
    protected final Setting<Double> crystalTrace = register(new NumberSetting<>("CrystalTrace", 6.0, 0.0, 10.0))
            .setComplexity(Complexity.Expert);
    protected final Setting<Double> crystalBreakTrace = register(new NumberSetting<>("CrystalTrace", 3.0, 0.0, 10.0))
            .setComplexity(Complexity.Expert);
    protected final Setting<Double> minDmg = register(new NumberSetting<>("MinDamage", 10.0, 0.0, 36.0))
            .setComplexity(Complexity.Medium);
    protected final Setting<Double> maxSelfDmg = register(new NumberSetting<>("MaxSelfDamage", 10.0, 0.0, 36.0))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> newVer = register(new BooleanSetting("1.13", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> newVerEntities = register(new BooleanSetting("1.13-Entities", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> growRender = register(new BooleanSetting("GrowRender", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Color> pbColor = register(new ColorSetting("PB-Color", new Color(0, 255, 0, 240)))
            .setComplexity(Complexity.Expert);
    protected final Setting<Color> pbOutline = register(new ColorSetting("PB-Outline", new Color(0, 255, 0, 120)))
            .setComplexity(Complexity.Expert);
    public final Setting<Color> color = register(new ColorSetting("Color", new Color(0, 255, 0, 240)))
            .setComplexity(Complexity.Expert);
    public final Setting<Color> outlinecolor = register(new ColorSetting("OutColor", new Color(0, 255, 0, 240)))
            .setComplexity(Complexity.Expert);
    public final NumberSetting<Float> lineWidth = register(new NumberSetting<>("LineWidth", 1.5f, 0.1f, 5f));
    /*
     ...
     * 
     */
    protected final Setting<Boolean> tpsSync = register(new BooleanSetting("TpsSync", false))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> abortNextTick = register(new BooleanSetting("AbortNextTick", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> cancelNormalPackets = register(new BooleanSetting("CancelNormalPackets", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> cancelClick = register(new BooleanSetting("CancelClick", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> cancelEvent = register(new BooleanSetting("CancelEvent", true))
            .setComplexity(Complexity.Expert);
    protected final Setting<Integer> aASSwitchTime = register(new NumberSetting<>("AASSwitchTime", 500, 0, 1000))
            .setComplexity(Complexity.Medium);
    protected final Setting<Boolean> resetFastOnAir = register(new BooleanSetting("ResetFastOnAir", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Boolean> resetFastOnNonAir = register(new BooleanSetting("ResetFastOnNonAir", false))
            .setComplexity(Complexity.Expert);
    protected final Setting<Integer> tickTime = register(new NumberSetting<>("TickTime", 50, 0, 200))
            .setComplexity(Complexity.Expert);

    protected final FastHelper fastHelper = new FastHelper(this);
    public final CrystalHelper crystalHelper = new CrystalHelper(this);
    protected final OngroundHistoryHelper ongroundHistoryHelper = new OngroundHistoryHelper();
        ...
        if (breakCrystal.getValue()) {
            ...
            for (Entity crystal : mc.world.loadedEntityList) {
                ...
                if (crystal instanceof EntityEnderCrystal
                        ...
                        && (mc.player.canEntityBeSeen(crystal)
                                || distance < MathUtil.square(crystalBreakTrace.getValue()))) {
