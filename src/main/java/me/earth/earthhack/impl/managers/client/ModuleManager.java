...
import me.earth.earthhack.impl.modules.combat.blockerbait.BlockerBait;
...
import me.earth.earthhack.impl.modules.misc.clownfat.ClownFat;
...
import me.earth.earthhack.impl.modules.misc.holdmodules.HoldModule;
import me.earth.earthhack.impl.modules.misc.holdmodules.HoldModule2;
import me.earth.earthhack.impl.modules.misc.holdmodules.HoldModule3;
...
import me.earth.earthhack.impl.modules.movement.hitboxdesync.HitboxDesync2;
...
public class ModuleManager extends IterationRegister<Module> {
    public void init() {
      ...
      //  this.forceRegister(new PbTeleport());
        ...
        this.forceRegister(new BlockerBait());
        //this.forceRegister(new BowSpam());
        this.forceRegister(new ClownFat());
